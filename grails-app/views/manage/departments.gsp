...
<div class="content-wrapper">
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Departments
                <g:link controller="manage" action="add_department" class="btn btn-default btn-sm"><i class="icon-plus-circle2 text-blue"></i>&nbsp;&nbsp;Add Department</g:link>
            </h5>
        </div>
            ...
            <div class="row section-margin">
                <div class="col-md-offset-4 col-md-4 col-md-offset-4">
                    <ul class="pagination pagination-separated pagination-rounded">
                        <li><g:if test="${page_number > 1}"><g:link controller="manage" action="departments" params="[page_number: page_number - 1]">&lsaquo;</g:link></g:if></li>
                        <g:each in="${number_of_pages}" var="page_list">
                            <li class="${page_number == page_list ? 'active' : ''}"><g:link controller="manage" action="departments" params="[page_number: page_list]">${page_list}</g:link></li>
                        </g:each>
                        <li><g:if test="${number_of_pages != null}"><g:if test="${page_number < number_of_pages.size()}"><g:link controller="manage" action="departments" params="[page_number: page_number + 1]">&rsaquo;</g:link></g:if></g:if></li>
                    </ul>
                </div>
            </div>
        </div>
