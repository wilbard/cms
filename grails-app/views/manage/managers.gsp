...
<div class="content-wrapper">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Supervisors
                <g:link controller="manage" action="add_manager" class="btn btn-default btn-sm"><i class="icon-plus-circle2 text-blue"></i>&nbsp;&nbsp;Add Supervisor</g:link>
            </h5>
        </div>
